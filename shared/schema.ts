...
export const createPlanSchema = z.object({
  ...
  durationUnit: z.enum(["day", "week", "month", "year"]).nullable().optional(),
...
export const branchChargeEvents = pgTable("branch_charge_events", {
  ...
  paymentEffectiveDate: date("payment_effective_date"),
  coverageStartAt: timestamp("coverage_start_at", { withTimezone: true }),
  coverageEndAt: timestamp("coverage_end_at", { withTimezone: true }),
  durationUnitSnapshot: text("duration_unit_snapshot"),
  durationValueSnapshot: integer("duration_value_snapshot"),
